...
<div style={{padding:'10px 14px',background:'linear-gradient(135deg,#1e3a5f,#0d7a3f)',color:'white'}}><b>PHLedger Finance Agent</b><div style={{fontSize:'.6rem',opacity:.8}}>Powered by PHLedger</div></div>
