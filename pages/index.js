            ...
            <div className="cs">
              <div className="cs-h">
                ...
                <div className="d-flex gap-2">
                  <input className="form-control form-control-sm" placeholder="Search..." value={search} onChange={e=>setSearch(e.target.value)} style={{width:170}}/>
                  <select className="form-select form-select-sm" value={bnkF} onChange={e=>setBnkF(e.target.value)} style={{width:130}}>
                ...
                {[
                  ...
                  <div key={side} className="col-md-6">
                    <div className="cs">
                      ...
                      <div className="cs-b">
                        <select className="form-select form-select-sm mb-3" value={sel} onChange={e=>setSel(e.target.value)}>
                        ...
                        <div className={`uz${drag?' over':''}`}
                          ...
                          <input type="file" ref={ref} className="d-none" accept=".csv" onChange={e=>handleUpload(e,sel,side)}/>
                        </div>
            ...
            <div className="cs" style={{maxWidth:680}}>
              ...
              <div className="cs-b">
                ...
                <div className="d-flex gap-2 mt-3">
                  <input className="form-control" placeholder="Try: 'au p&l', 'bas', 'status', 'help'" value={ci} onChange={e=>setCi(e.target.value)} onKeyDown={e=>e.key==='Enter'&&sendChat()}/>
